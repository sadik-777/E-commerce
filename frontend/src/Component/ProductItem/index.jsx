...
<div className="productItem group relative p-5 bg-white border-r border-b border-gray-100 flex flex-col h-full hover:shadow-2xl hover:z-20 transition-all duration-300">
      ...
      <div className="imgWrapper w-full h-[180px] flex items-center justify-center mb-6 overflow-hidden">
        <img 
      ...
      <div className="info flex flex-col flex-grow">
        <h4 className="text-[14px] font-semibold text-[#222] line-clamp-2 leading-tight h-[40px] mb-2 group-hover:text-[#2bbef9] transition-colors">
        ...
        {/* Price Section */}
        <div className="price flex items-center gap-2 mb-5">
        ...
        {/* Add to Cart Button */}
        <button className="mt-auto w-full bg-white border border-[#2bbef9] text-[#2bbef9] rounded-full py-2 px-4 text-[12px] font-bold hover:bg-[#2bbef9] hover:text-white transition-all duration-300">
          Add to cart
        </button>
      </div>
    </div>
